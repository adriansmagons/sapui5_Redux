sap.ui.define([
...
], function(BaseObject, Reselect, commonSelectors) {
    return BaseObject.extend("ui5.fitnessApp.selectors.appStateSelectors", {
        ...
        createSelectTable:function(){
            return Reselect.createSelector([this.commonSelectors.selectAthletes, this.selectTableSorting.bind(this), this.selectTableFiltering.bind(this)], (oAthletes, oSortDetails, oFilterDetails) =>{   // Returns athletes with sorting and filtering
