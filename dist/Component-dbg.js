  ...
  return UIComponent.extend("ui5.fitnessApp.Component", {
    ...
    init() {
      ...
      preprocessor.fetchData(aUrls).then(result => {
        const oLoadDataAction = this.commonActions.loadData({
          oData: preprocessor.processAthletes(result),
