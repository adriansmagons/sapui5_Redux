sap.ui.define(["sap/ui/base/Object", "ui5/fitnessApp/thirdparty/reselect", "ui5/fitnessApp/selectors/commonSelectors", "ui5/fitnessApp/selectors/appStateSelectors"], function (BaseObject, Reselect, commonSelectors, appStateSelectors) {
  return BaseObject.extend("ui5.fitnessApp.selectors.athleteSelectors", {
    ...
    createSelectVisibleAthletes: function () {
      return Reselect.createSelector([this.appStateSelectors.selectTable], oVisibleAthletes => {
